 ...
 * @param array|ClosureParser|string $options An array of parsing options, or an
 *                                            instance of a parser
 *
 * @return string                    The serialized closure
 * @throws \InvalidArgumentException if neither an array of options or and
 *                                   instance of a parser are provided
 */
